...
これまで積んできたクラウドの構築・運用保守の実務経験は小規模でエンドユーザーが限られたサービスが多かったため、より大規模で複雑なクラウドアーキテクチャの設計・構築・運用に携わることで成長したいと考えています。現在の経験を基に、高可用性・高スケーラビリティを実現したシステムや、より細かいルールの監視・ログ収集・アラートの設計・実装の経験を積んでいきたいです。
技術的な成長だけでなく、これまでのプロジェクト進行の経験を活かし、チーム内でのリーダーシップや、顧客との要件調整など、技術面以外でも貢献できるエンジニアとして成長したいと考えています。
